import type { EnhancedCorrection } from '@/features/Fast-IaCorrection/hooks/useIaCorrection';
...
const HighlightOverlayer: React.FC<Props> = ({text, corrections}) => {
    ...
    sortedCorrection.forEach(correction => {
        ...
        parts.push(
            <span key={correction.id} className="border-b-2 border-red-500 bg-red-100/20">
